...
package datamspr.voteelection_0_1;
 ...
 * @status
 */
public class VoteElection implements TalendJob {
	...
	private final String jobName = "VoteElection";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(VoteElection.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_DATAMSPR_VoteElection = new byte[0];
		static byte[] commonByteArray_DATAMSPR_VoteElection = new byte[0];
		...
		public Integer NumeroPanneau11;

		public Integer getNumeroPanneau11() {
			return this.NumeroPanneau11;
		}

		public String Sexe11;

		public String getSexe11() {
			return this.Sexe11;
		}
		...
		public String Prenom11;

		public String getPrenom11() {
			return this.Prenom11;
		}

		public Integer Voix11;

		public Integer getVoix11() {
			return this.Voix11;
		}

		public BigDecimal PourcentageVoix_Inscrit11;

		public BigDecimal getPourcentageVoix_Inscrit11() {
			return this.PourcentageVoix_Inscrit11;
		}

		public BigDecimal PourcentageVoix_Exprime11;

		public BigDecimal getPourcentageVoix_Exprime11() {
			return this.PourcentageVoix_Exprime11;
		}
		...
		public void copyDataTo(row4Struct other) {
			...
			other.NumeroPanneau11 = this.NumeroPanneau11;
			other.Sexe11 = this.Sexe11;
			other.Nom11 = this.Nom11;
			other.Prenom11 = this.Prenom11;
			other.Voix11 = this.Voix11;
			other.PourcentageVoix_Inscrit11 = this.PourcentageVoix_Inscrit11;
			other.PourcentageVoix_Exprime11 = this.PourcentageVoix_Exprime11;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DATAMSPR_VoteElection.length) {
					if (length < 1024 && commonByteArray_DATAMSPR_VoteElection.length == 0) {
						commonByteArray_DATAMSPR_VoteElection = new byte[1024];
					} else {
						commonByteArray_DATAMSPR_VoteElection = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DATAMSPR_VoteElection, 0, length);
				strReturn = new String(commonByteArray_DATAMSPR_VoteElection, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_DATAMSPR_VoteElection, 0, length);
				strReturn = new String(commonByteArray_DATAMSPR_VoteElection, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATAMSPR_VoteElection) {
				...
				try {
					...
					this.NumeroPanneau11 = readInteger(dis);

					this.Sexe11 = readString(dis);

					this.Nom11 = readString(dis);

					this.Prenom11 = readString(dis);

					this.Voix11 = readInteger(dis);

					this.PourcentageVoix_Inscrit11 = (BigDecimal) dis.readObject();

					this.PourcentageVoix_Exprime11 = (BigDecimal) dis.readObject();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.NumeroPanneau11, dos);

				// String

				writeString(this.Sexe11, dos);

				// String

				writeString(this.Nom11, dos);

				// String

				writeString(this.Prenom11, dos);

				// Integer

				writeInteger(this.Voix11, dos);

				// BigDecimal

				dos.writeObject(this.PourcentageVoix_Inscrit11);

				// BigDecimal

				dos.writeObject(this.PourcentageVoix_Exprime11);
		...
		public String toString() {
			...
			sb.append(",NumeroPanneau11=" + String.valueOf(NumeroPanneau11));
			sb.append(",Sexe11=" + Sexe11);
			sb.append(",Nom11=" + Nom11);
			sb.append(",Prenom11=" + Prenom11);
			sb.append(",Voix11=" + String.valueOf(Voix11));
			sb.append(",PourcentageVoix_Inscrit11=" + String.valueOf(PourcentageVoix_Inscrit11));
			sb.append(",PourcentageVoix_Exprime11=" + String.valueOf(PourcentageVoix_Exprime11));
			sb.append("]");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public String CodeBVote;

		public String getCodeBVote() {
			return this.CodeBVote;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DATAMSPR_VoteElection) {
				...
				try {
					...
					this.CodeCommune = readString(dis);

					this.LibelleCommune = readString(dis);

					this.CodeBVote = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.CodeCommune, dos);

				// String

				writeString(this.LibelleCommune, dos);

				// String

				writeString(this.CodeBVote, dos);
		...
		public String toString() {
			...
			sb.append(",CodeCirconscription=" + CodeCirconscription);
			sb.append(",LibelleCirconscription=" + LibelleCirconscription);
			sb.append(",CodeCommune=" + CodeCommune);
			sb.append(",LibelleCommune=" + LibelleCommune);
			sb.append(",CodeBVote=" + CodeBVote);
			sb.append(",Inscrit=" + String.valueOf(Inscrit));
			sb.append(",Abstention=" + String.valueOf(Abstention));
			sb.append(",PourcentageAbstention_Inscrit=" + String.valueOf(PourcentageAbstention_Inscrit));
			sb.append(",Votant=" + String.valueOf(Votant));
	...
	public void tFileInputExcel_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				copyOfout1Struct row2 = copyOfout1;
				...
				class FileOutputDelimitedUtil_tFileOutputDelimited_1 {
					...
					public void putHeaderValue_1(java.io.Writer outtFileOutputDelimited_1,
						...
						outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
						outtFileOutputDelimited_1.write("NumeroPanneau11");
						outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
						outtFileOutputDelimited_1.write("Sexe11");
						outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
						outtFileOutputDelimited_1.write("Nom11");
						outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
						outtFileOutputDelimited_1.write("Prenom11");
						outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
						outtFileOutputDelimited_1.write("Voix11");
						outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
						outtFileOutputDelimited_1.write("PourcentageVoix_Inscrit11");
						outtFileOutputDelimited_1.write(OUT_DELIM_tFileOutputDelimited_1);
						outtFileOutputDelimited_1.write("PourcentageVoix_Exprime11");
					}
					...
					public void putValue_1(final row4Struct row4, StringBuilder sb_tFileOutputDelimited_1,
						...
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row4.NumeroPanneau11 != null) {
							sb_tFileOutputDelimited_1.append(row4.NumeroPanneau11);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row4.Sexe11 != null) {
							sb_tFileOutputDelimited_1.append(row4.Sexe11);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row4.Nom11 != null) {
							sb_tFileOutputDelimited_1.append(row4.Nom11);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row4.Prenom11 != null) {
							sb_tFileOutputDelimited_1.append(row4.Prenom11);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row4.Voix11 != null) {
							sb_tFileOutputDelimited_1.append(row4.Voix11);
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row4.PourcentageVoix_Inscrit11 != null) {
							sb_tFileOutputDelimited_1.append(row4.PourcentageVoix_Inscrit11.toPlainString());
						}
						sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
						if (row4.PourcentageVoix_Exprime11 != null) {
							sb_tFileOutputDelimited_1.append(row4.PourcentageVoix_Exprime11.toPlainString());
						}
					}
				}
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DATAMSPR/_output/VoteElection2022.csv"))
				...
				class Util_tLogRow_1 {
					...
					public StringBuilder format() {
						...
						sb.append("|");
						int k = 0;
						for (k = 0; k < (totals + 102 - name.length()) / 2; k++) {
							sb.append(' ');
						}
						sb.append(name);
						for (int i = 0; i < totals + 102 - name.length() - k; i++) {
							sb.append(' ');
						}
						sb.append("|\n");
					...
					private StringBuilder print(String[] fillChars) {
						...
						// last column
						for (int i = 0; i < colLengths[102] - fillChars[1].length() + 1; i++) {
							sb.append(fillChars[2]);
						}
				...
				util_tLogRow_1.addRow(new String[] { "Id", "CodeDepartement", "LibelleDepartement",
						...
						"NumeroPanneau11", "Sexe11", "Nom11", "Prenom11", "Voix11", "PourcentageVoix_Inscrit11",
						"PourcentageVoix_Exprime11", });
				StringBuilder strBuffer_tLogRow_1 = null;
				int nb_line_tLogRow_1 = 0;
///////////////////////    			

				class LogRowUtil_tLogRow_1 {
					public void putTableVerticalValue_0(final copyOfout1Struct copyOfout1, String[] row_tLogRow_1) {
						row_tLogRow_1[0] = String.valueOf(copyOfout1.Id);
						if (copyOfout1.CodeDepartement != null) { //
							row_tLogRow_1[1] = String.valueOf(copyOfout1.CodeDepartement);
						} //
						if (copyOfout1.LibelleDepartement != null) { //
							row_tLogRow_1[2] = String.valueOf(copyOfout1.LibelleDepartement);
						} //
						if (copyOfout1.CodeCirconscription != null) { //
							row_tLogRow_1[3] = String.valueOf(copyOfout1.CodeCirconscription);
						} //
						if (copyOfout1.LibelleCirconscription != null) { //
							row_tLogRow_1[4] = String.valueOf(copyOfout1.LibelleCirconscription);
						} //
						if (copyOfout1.Inscrit != null) { //
							row_tLogRow_1[5] = String.valueOf(copyOfout1.Inscrit);
						} //
						if (copyOfout1.Abstention != null) { //
							row_tLogRow_1[6] = String.valueOf(copyOfout1.Abstention);
						} //
						if (copyOfout1.PourcentageAbstention_Inscrit != null) { //
							row_tLogRow_1[7] = copyOfout1.PourcentageAbstention_Inscrit.toPlainString();
						} //
						if (copyOfout1.Votant != null) { //
							row_tLogRow_1[8] = String.valueOf(copyOfout1.Votant);
						} //
						if (copyOfout1.PourcentageVotant_Inscrit != null) { //
							row_tLogRow_1[9] = copyOfout1.PourcentageVotant_Inscrit.toPlainString();
						} //
						if (copyOfout1.VoteBlanc != null) { //
							row_tLogRow_1[10] = String.valueOf(copyOfout1.VoteBlanc);
						} //
						if (copyOfout1.PourcentageBlanc_Inscrit != null) { //
							row_tLogRow_1[11] = copyOfout1.PourcentageBlanc_Inscrit.toPlainString();
						} //
						if (copyOfout1.PourcentageBlanc_Votant != null) { //
							row_tLogRow_1[12] = copyOfout1.PourcentageBlanc_Votant.toPlainString();
						} //
						if (copyOfout1.VoteNul != null) { //
							row_tLogRow_1[13] = String.valueOf(copyOfout1.VoteNul);
						} //
						if (copyOfout1.PourcentageNul_Inscrit != null) { //
							row_tLogRow_1[14] = copyOfout1.PourcentageNul_Inscrit.toPlainString();
						} //
						if (copyOfout1.PourcentageNul_Votant != null) { //
							row_tLogRow_1[15] = copyOfout1.PourcentageNul_Votant.toPlainString();
						} //
						if (copyOfout1.Exprime != null) { //
							row_tLogRow_1[16] = String.valueOf(copyOfout1.Exprime);
						} //
						if (copyOfout1.PourcentageExprime_Inscrit != null) { //
							row_tLogRow_1[17] = copyOfout1.PourcentageExprime_Inscrit.toPlainString();
						} //
						if (copyOfout1.PourcentageExprime_Votant != null) { //
							row_tLogRow_1[18] = copyOfout1.PourcentageExprime_Votant.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau != null) { //
							row_tLogRow_1[19] = String.valueOf(copyOfout1.NumeroPanneau);
						} //
						if (copyOfout1.Sexe != null) { //
							row_tLogRow_1[20] = String.valueOf(copyOfout1.Sexe);
						} //
						if (copyOfout1.Nom != null) { //
							row_tLogRow_1[21] = String.valueOf(copyOfout1.Nom);
						} //
						if (copyOfout1.Prenom != null) { //
							row_tLogRow_1[22] = String.valueOf(copyOfout1.Prenom);
						} //
						if (copyOfout1.Voix != null) { //
							row_tLogRow_1[23] = String.valueOf(copyOfout1.Voix);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit != null) { //
							row_tLogRow_1[24] = copyOfout1.PourcentageVoix_Inscrit.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime != null) { //
							row_tLogRow_1[25] = copyOfout1.PourcentageVoix_Exprime.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau1 != null) { //
							row_tLogRow_1[26] = String.valueOf(copyOfout1.NumeroPanneau1);
						} //
						if (copyOfout1.Sexe1 != null) { //
							row_tLogRow_1[27] = String.valueOf(copyOfout1.Sexe1);
						} //
						if (copyOfout1.Nom1 != null) { //
							row_tLogRow_1[28] = String.valueOf(copyOfout1.Nom1);
						} //
						if (copyOfout1.Prenom1 != null) { //
							row_tLogRow_1[29] = String.valueOf(copyOfout1.Prenom1);
						} //
						if (copyOfout1.Voix1 != null) { //
							row_tLogRow_1[30] = String.valueOf(copyOfout1.Voix1);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit1 != null) { //
							row_tLogRow_1[31] = copyOfout1.PourcentageVoix_Inscrit1.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime1 != null) { //
							row_tLogRow_1[32] = copyOfout1.PourcentageVoix_Exprime1.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau2 != null) { //
							row_tLogRow_1[33] = String.valueOf(copyOfout1.NumeroPanneau2);
						} //
						if (copyOfout1.Sexe2 != null) { //
							row_tLogRow_1[34] = String.valueOf(copyOfout1.Sexe2);
						} //
						if (copyOfout1.Nom2 != null) { //
							row_tLogRow_1[35] = String.valueOf(copyOfout1.Nom2);
						} //
						if (copyOfout1.Prenom2 != null) { //
							row_tLogRow_1[36] = String.valueOf(copyOfout1.Prenom2);
						} //
						if (copyOfout1.Voix2 != null) { //
							row_tLogRow_1[37] = String.valueOf(copyOfout1.Voix2);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit2 != null) { //
							row_tLogRow_1[38] = copyOfout1.PourcentageVoix_Inscrit2.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime2 != null) { //
							row_tLogRow_1[39] = copyOfout1.PourcentageVoix_Exprime2.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau3 != null) { //
							row_tLogRow_1[40] = String.valueOf(copyOfout1.NumeroPanneau3);
						} //
						if (copyOfout1.Sexe3 != null) { //
							row_tLogRow_1[41] = String.valueOf(copyOfout1.Sexe3);
						} //
						if (copyOfout1.Nom3 != null) { //
							row_tLogRow_1[42] = String.valueOf(copyOfout1.Nom3);
						} //
						if (copyOfout1.Prenom3 != null) { //
							row_tLogRow_1[43] = String.valueOf(copyOfout1.Prenom3);
						} //
						if (copyOfout1.Voix3 != null) { //
							row_tLogRow_1[44] = String.valueOf(copyOfout1.Voix3);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit3 != null) { //
							row_tLogRow_1[45] = copyOfout1.PourcentageVoix_Inscrit3.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime3 != null) { //
							row_tLogRow_1[46] = copyOfout1.PourcentageVoix_Exprime3.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau4 != null) { //
							row_tLogRow_1[47] = String.valueOf(copyOfout1.NumeroPanneau4);
						} //
						if (copyOfout1.Sexe4 != null) { //
							row_tLogRow_1[48] = String.valueOf(copyOfout1.Sexe4);
						} //
						if (copyOfout1.Nom4 != null) { //
							row_tLogRow_1[49] = String.valueOf(copyOfout1.Nom4);
						} //
						if (copyOfout1.Prenom4 != null) { //
							row_tLogRow_1[50] = String.valueOf(copyOfout1.Prenom4);
						} //
						if (copyOfout1.Voix4 != null) { //
							row_tLogRow_1[51] = String.valueOf(copyOfout1.Voix4);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit4 != null) { //
							row_tLogRow_1[52] = copyOfout1.PourcentageVoix_Inscrit4.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime4 != null) { //
							row_tLogRow_1[53] = copyOfout1.PourcentageVoix_Exprime4.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau5 != null) { //
							row_tLogRow_1[54] = String.valueOf(copyOfout1.NumeroPanneau5);
						} //
						if (copyOfout1.Sexe5 != null) { //
							row_tLogRow_1[55] = String.valueOf(copyOfout1.Sexe5);
						} //
						if (copyOfout1.Nom5 != null) { //
							row_tLogRow_1[56] = String.valueOf(copyOfout1.Nom5);
						} //
						if (copyOfout1.Prenom5 != null) { //
							row_tLogRow_1[57] = String.valueOf(copyOfout1.Prenom5);
						} //
						if (copyOfout1.Voix5 != null) { //
							row_tLogRow_1[58] = String.valueOf(copyOfout1.Voix5);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit5 != null) { //
							row_tLogRow_1[59] = copyOfout1.PourcentageVoix_Inscrit5.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime5 != null) { //
							row_tLogRow_1[60] = copyOfout1.PourcentageVoix_Exprime5.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau6 != null) { //
							row_tLogRow_1[61] = String.valueOf(copyOfout1.NumeroPanneau6);
						} //
						if (copyOfout1.Sexe6 != null) { //
							row_tLogRow_1[62] = String.valueOf(copyOfout1.Sexe6);
						} //
						if (copyOfout1.Nom6 != null) { //
							row_tLogRow_1[63] = String.valueOf(copyOfout1.Nom6);
						} //
						if (copyOfout1.Prenom6 != null) { //
							row_tLogRow_1[64] = String.valueOf(copyOfout1.Prenom6);
						} //
						if (copyOfout1.Voix6 != null) { //
							row_tLogRow_1[65] = String.valueOf(copyOfout1.Voix6);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit6 != null) { //
							row_tLogRow_1[66] = copyOfout1.PourcentageVoix_Inscrit6.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime6 != null) { //
							row_tLogRow_1[67] = copyOfout1.PourcentageVoix_Exprime6.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau7 != null) { //
							row_tLogRow_1[68] = String.valueOf(copyOfout1.NumeroPanneau7);
						} //
						if (copyOfout1.Sexe7 != null) { //
							row_tLogRow_1[69] = String.valueOf(copyOfout1.Sexe7);
						} //
						if (copyOfout1.Nom7 != null) { //
							row_tLogRow_1[70] = String.valueOf(copyOfout1.Nom7);
						} //
						if (copyOfout1.Prenom7 != null) { //
							row_tLogRow_1[71] = String.valueOf(copyOfout1.Prenom7);
						} //
						if (copyOfout1.Voix7 != null) { //
							row_tLogRow_1[72] = String.valueOf(copyOfout1.Voix7);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit7 != null) { //
							row_tLogRow_1[73] = copyOfout1.PourcentageVoix_Inscrit7.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime7 != null) { //
							row_tLogRow_1[74] = copyOfout1.PourcentageVoix_Exprime7.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau8 != null) { //
							row_tLogRow_1[75] = String.valueOf(copyOfout1.NumeroPanneau8);
						} //
						if (copyOfout1.Sexe8 != null) { //
							row_tLogRow_1[76] = String.valueOf(copyOfout1.Sexe8);
						} //
						if (copyOfout1.Nom8 != null) { //
							row_tLogRow_1[77] = String.valueOf(copyOfout1.Nom8);
						} //
						if (copyOfout1.Prenom8 != null) { //
							row_tLogRow_1[78] = String.valueOf(copyOfout1.Prenom8);
						} //
						if (copyOfout1.Voix8 != null) { //
							row_tLogRow_1[79] = String.valueOf(copyOfout1.Voix8);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit8 != null) { //
							row_tLogRow_1[80] = copyOfout1.PourcentageVoix_Inscrit8.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime8 != null) { //
							row_tLogRow_1[81] = copyOfout1.PourcentageVoix_Exprime8.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau9 != null) { //
							row_tLogRow_1[82] = String.valueOf(copyOfout1.NumeroPanneau9);
						} //
						if (copyOfout1.Sexe9 != null) { //
							row_tLogRow_1[83] = String.valueOf(copyOfout1.Sexe9);
						} //
						if (copyOfout1.Nom9 != null) { //
							row_tLogRow_1[84] = String.valueOf(copyOfout1.Nom9);
						} //
						if (copyOfout1.Prenom9 != null) { //
							row_tLogRow_1[85] = String.valueOf(copyOfout1.Prenom9);
						} //
						if (copyOfout1.Voix9 != null) { //
							row_tLogRow_1[86] = String.valueOf(copyOfout1.Voix9);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit9 != null) { //
							row_tLogRow_1[87] = copyOfout1.PourcentageVoix_Inscrit9.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime9 != null) { //
							row_tLogRow_1[88] = copyOfout1.PourcentageVoix_Exprime9.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau10 != null) { //
							row_tLogRow_1[89] = String.valueOf(copyOfout1.NumeroPanneau10);
						} //
						if (copyOfout1.Sexe10 != null) { //
							row_tLogRow_1[90] = String.valueOf(copyOfout1.Sexe10);
						} //
						if (copyOfout1.Nom10 != null) { //
							row_tLogRow_1[91] = String.valueOf(copyOfout1.Nom10);
						} //
						if (copyOfout1.Prenom10 != null) { //
							row_tLogRow_1[92] = String.valueOf(copyOfout1.Prenom10);
						} //
						if (copyOfout1.Voix10 != null) { //
							row_tLogRow_1[93] = String.valueOf(copyOfout1.Voix10);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit10 != null) { //
							row_tLogRow_1[94] = copyOfout1.PourcentageVoix_Inscrit10.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime10 != null) { //
							row_tLogRow_1[95] = copyOfout1.PourcentageVoix_Exprime10.toPlainString();
						} //
						if (copyOfout1.NumeroPanneau11 != null) { //
							row_tLogRow_1[96] = String.valueOf(copyOfout1.NumeroPanneau11);
						} //
						if (copyOfout1.Sexe11 != null) { //
							row_tLogRow_1[97] = String.valueOf(copyOfout1.Sexe11);
						} //
						if (copyOfout1.Nom11 != null) { //
							row_tLogRow_1[98] = String.valueOf(copyOfout1.Nom11);
						} //
						if (copyOfout1.Prenom11 != null) { //
							row_tLogRow_1[99] = String.valueOf(copyOfout1.Prenom11);
						} //
					}

					public void putTableVerticalValue_1(final copyOfout1Struct copyOfout1, String[] row_tLogRow_1) {
						if (copyOfout1.Voix11 != null) { //
							row_tLogRow_1[100] = String.valueOf(copyOfout1.Voix11);
						} //
						if (copyOfout1.PourcentageVoix_Inscrit11 != null) { //
							row_tLogRow_1[101] = copyOfout1.PourcentageVoix_Inscrit11.toPlainString();
						} //
						if (copyOfout1.PourcentageVoix_Exprime11 != null) { //
							row_tLogRow_1[102] = copyOfout1.PourcentageVoix_Exprime11.toPlainString();
						} //
					}
				}
...
// ###############################
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:uoBNNrmop4zoItFKDTwdlBLahJW/Jjm2TdgptQ==");
				String password_tFileInputExcel_1 = decryptedPassword_tFileInputExcel_1;
				if (password_tFileInputExcel_1.isEmpty()) {
					password_tFileInputExcel_1 = null;
				}
				Object source_tFileInputExcel_1 = "C:/Program Files (x86)/TOS_DI-8.0.1/studio/workspace/DATAMSPR/_input/resultats-par-niveau-burvot-t1-france-entiere.xlsx";
				...
				try {
					excelReader_tFileInputExcel_1.addSheetName("Résultats par niveau BurVot T1 ", false);
					int start_column_tFileInputExcel_1 = 1 - 1;
					int end_column_tFileInputExcel_1 = -1;
					if (start_column_tFileInputExcel_1 >= 0) {// follow start column

						end_column_tFileInputExcel_1 = start_column_tFileInputExcel_1 + 105 - 1;

					} else if (end_column_tFileInputExcel_1 >= 0) {// follow end column
						start_column_tFileInputExcel_1 = end_column_tFileInputExcel_1 - 105 + 1;
					}
					...
					while (excelReader_tFileInputExcel_1.hasNext()) {
						...
						row1 = null;
						int tempRowLength_tFileInputExcel_1 = 105;
						...
						try {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.CodeDepartement = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim();
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
										+ start_column_tFileInputExcel_1 + 1;
								curColName_tFileInputExcel_1 = "CodeCommune";

								row1.CodeCommune = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim();
							} else {
								row1.CodeCommune = null;
								emptyColumnCount_tFileInputExcel_1++;
							}
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
										+ start_column_tFileInputExcel_1 + 1;
								curColName_tFileInputExcel_1 = "LibelleCommune";

								row1.LibelleCommune = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim();
							} else {
								row1.LibelleCommune = null;
								emptyColumnCount_tFileInputExcel_1++;
							}
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
										+ start_column_tFileInputExcel_1 + 1;
								curColName_tFileInputExcel_1 = "CodeBVote";

								row1.CodeBVote = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim();
							} else {
								row1.CodeBVote = null;
								emptyColumnCount_tFileInputExcel_1++;
							}
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Inscrit = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Abstention = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageAbstention_Inscrit = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Votant = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Votant = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVotant_Inscrit = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.VoteBlanc = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.VoteBlanc = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageBlanc_Inscrit = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageBlanc_Votant = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.VoteNul = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.VoteNul = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageNul_Inscrit = ParserUtils.parseTo_BigDecimal(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageNul_Votant = ParserUtils.parseTo_BigDecimal(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Exprime = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Exprime = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageExprime_Inscrit = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageExprime_Votant = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.NumeroPanneau = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Voix = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Inscrit = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Exprime = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.NumeroPanneau1 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Voix1 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix1 = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Inscrit1 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Exprime1 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.NumeroPanneau2 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Voix2 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix2 = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Inscrit2 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Exprime2 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.NumeroPanneau3 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Voix3 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix3 = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Inscrit3 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Exprime3 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.NumeroPanneau4 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Voix4 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix4 = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Inscrit4 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Exprime4 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.NumeroPanneau5 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Voix5 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix5 = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Inscrit5 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Exprime5 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.NumeroPanneau6 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Voix6 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix6 = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Inscrit6 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Exprime6 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.NumeroPanneau7 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Voix7 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix7 = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Inscrit7 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Exprime7 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.NumeroPanneau8 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Voix8 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix8 = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Inscrit8 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Exprime8 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.NumeroPanneau9 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Voix9 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix9 = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Inscrit9 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Exprime9 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.NumeroPanneau10 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.Voix10 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix10 = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Inscrit10 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								...
								row1.PourcentageVoix_Exprime10 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
										+ start_column_tFileInputExcel_1 + 1;
								curColName_tFileInputExcel_1 = "NumeroPanneau11";

								row1.NumeroPanneau11 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.NumeroPanneau11 = null;
								emptyColumnCount_tFileInputExcel_1++;
							}
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
										+ start_column_tFileInputExcel_1 + 1;
								curColName_tFileInputExcel_1 = "Sexe11";

								row1.Sexe11 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim();
							} else {
								row1.Sexe11 = null;
								emptyColumnCount_tFileInputExcel_1++;
							}
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
										+ start_column_tFileInputExcel_1 + 1;
								curColName_tFileInputExcel_1 = "Nom11";

								row1.Nom11 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim();
							} else {
								row1.Nom11 = null;
								emptyColumnCount_tFileInputExcel_1++;
							}
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
										+ start_column_tFileInputExcel_1 + 1;
								curColName_tFileInputExcel_1 = "Prenom11";

								row1.Prenom11 = temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim();
							} else {
								row1.Prenom11 = null;
								emptyColumnCount_tFileInputExcel_1++;
							}
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
										+ start_column_tFileInputExcel_1 + 1;
								curColName_tFileInputExcel_1 = "Voix11";

								row1.Voix11 = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
										temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
										'.' == decimalChar_tFileInputExcel_1 ? null : decimalChar_tFileInputExcel_1));
							} else {
								row1.Voix11 = null;
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
										+ start_column_tFileInputExcel_1 + 1;
								curColName_tFileInputExcel_1 = "PourcentageVoix_Inscrit11";

								row1.PourcentageVoix_Inscrit11 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							} else {
								row1.PourcentageVoix_Inscrit11 = null;
								emptyColumnCount_tFileInputExcel_1++;
							}
							...
							if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim().length() > 0) {
								curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
										+ start_column_tFileInputExcel_1 + 1;
								curColName_tFileInputExcel_1 = "PourcentageVoix_Exprime11";

								row1.PourcentageVoix_Exprime11 = ParserUtils
										.parseTo_BigDecimal(ParserUtils.parseTo_Number(
												temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].trim(), null,
												'.' == decimalChar_tFileInputExcel_1 ? null
														: decimalChar_tFileInputExcel_1));
							} else {
								row1.PourcentageVoix_Exprime11 = null;
								emptyColumnCount_tFileInputExcel_1++;
							}
...
// Start of branch "row1"
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								Var.Candidat = row1.NumeroPanneau + ";" + row1.Sexe + ";" + row1.Nom + ";" + row1.Prenom
										+ ";" + row1.Voix + ";" + row1.PourcentageVoix_Inscrit + ";"
								...
								Var.Candidat11 = row1.NumeroPanneau11 + ";" + row1.Sexe11 + ";" + row1.Nom11 + ";"
										+ row1.Prenom11 + ";" + row1.Voix11 + ";" + row1.PourcentageVoix_Inscrit11 + ";"
										+ row1.PourcentageVoix_Exprime11;// ###############################
								// ###############################
								// # Output tables
...
// # Output table : 'copyOfout1'
								copyOfout1_tmp.Id = Var.Id;
								copyOfout1_tmp.CodeDepartement = row1.CodeDepartement;
								copyOfout1_tmp.LibelleDepartement = row1.LibelleDepartement;
								copyOfout1_tmp.CodeCirconscription = row1.CodeCirconscription;
								copyOfout1_tmp.LibelleCirconscription = row1.LibelleCirconscription;
								copyOfout1_tmp.Inscrit = row1.Inscrit;
								copyOfout1_tmp.Abstention = row1.Abstention;
								copyOfout1_tmp.PourcentageAbstention_Inscrit = row1.PourcentageAbstention_Inscrit;
								copyOfout1_tmp.Votant = row1.Votant;
								copyOfout1_tmp.PourcentageVotant_Inscrit = row1.PourcentageVotant_Inscrit;
								copyOfout1_tmp.VoteBlanc = row1.VoteBlanc;
								copyOfout1_tmp.PourcentageBlanc_Inscrit = row1.PourcentageBlanc_Inscrit;
								copyOfout1_tmp.PourcentageBlanc_Votant = row1.PourcentageBlanc_Votant;
								copyOfout1_tmp.VoteNul = row1.VoteNul;
								copyOfout1_tmp.PourcentageNul_Inscrit = row1.PourcentageNul_Inscrit;
								copyOfout1_tmp.PourcentageNul_Votant = row1.PourcentageNul_Votant;
								copyOfout1_tmp.Exprime = row1.Exprime;
								copyOfout1_tmp.PourcentageExprime_Inscrit = row1.PourcentageExprime_Inscrit;
								copyOfout1_tmp.PourcentageExprime_Votant = row1.PourcentageExprime_Votant;
								copyOfout1_tmp.NumeroPanneau = row1.NumeroPanneau;
								copyOfout1_tmp.Sexe = row1.Sexe;
								copyOfout1_tmp.Nom = row1.Nom;
								copyOfout1_tmp.Prenom = row1.Prenom;
								copyOfout1_tmp.Voix = row1.Voix;
								copyOfout1_tmp.PourcentageVoix_Inscrit = row1.PourcentageVoix_Inscrit;
								copyOfout1_tmp.PourcentageVoix_Exprime = row1.PourcentageVoix_Exprime;
								copyOfout1_tmp.NumeroPanneau1 = row1.NumeroPanneau1;
								copyOfout1_tmp.Sexe1 = row1.Sexe1;
								copyOfout1_tmp.Nom1 = row1.Nom1;
								copyOfout1_tmp.Prenom1 = row1.Prenom1;
								copyOfout1_tmp.Voix1 = row1.Voix1;
								copyOfout1_tmp.PourcentageVoix_Inscrit1 = row1.PourcentageVoix_Inscrit1;
								copyOfout1_tmp.PourcentageVoix_Exprime1 = row1.PourcentageVoix_Exprime1;
								copyOfout1_tmp.NumeroPanneau2 = row1.NumeroPanneau2;
								copyOfout1_tmp.Sexe2 = row1.Sexe2;
								copyOfout1_tmp.Nom2 = row1.Nom2;
								copyOfout1_tmp.Prenom2 = row1.Prenom2;
								copyOfout1_tmp.Voix2 = row1.Voix2;
								copyOfout1_tmp.PourcentageVoix_Inscrit2 = row1.PourcentageVoix_Inscrit2;
								copyOfout1_tmp.PourcentageVoix_Exprime2 = row1.PourcentageVoix_Exprime2;
								copyOfout1_tmp.NumeroPanneau3 = row1.NumeroPanneau3;
								copyOfout1_tmp.Sexe3 = row1.Sexe3;
								copyOfout1_tmp.Nom3 = row1.Nom3;
								copyOfout1_tmp.Prenom3 = row1.Prenom3;
								copyOfout1_tmp.Voix3 = row1.Voix3;
								copyOfout1_tmp.PourcentageVoix_Inscrit3 = row1.PourcentageVoix_Inscrit3;
								copyOfout1_tmp.PourcentageVoix_Exprime3 = row1.PourcentageVoix_Exprime3;
								copyOfout1_tmp.NumeroPanneau4 = row1.NumeroPanneau4;
								copyOfout1_tmp.Sexe4 = row1.Sexe4;
								copyOfout1_tmp.Nom4 = row1.Nom4;
								copyOfout1_tmp.Prenom4 = row1.Prenom4;
								copyOfout1_tmp.Voix4 = row1.Voix4;
								copyOfout1_tmp.PourcentageVoix_Inscrit4 = row1.PourcentageVoix_Inscrit4;
								copyOfout1_tmp.PourcentageVoix_Exprime4 = row1.PourcentageVoix_Exprime4;
								copyOfout1_tmp.NumeroPanneau5 = row1.NumeroPanneau5;
								copyOfout1_tmp.Sexe5 = row1.Sexe5;
								copyOfout1_tmp.Nom5 = row1.Nom5;
								copyOfout1_tmp.Prenom5 = row1.Prenom5;
								copyOfout1_tmp.Voix5 = row1.Voix5;
								copyOfout1_tmp.PourcentageVoix_Inscrit5 = row1.PourcentageVoix_Inscrit5;
								copyOfout1_tmp.PourcentageVoix_Exprime5 = row1.PourcentageVoix_Exprime5;
								copyOfout1_tmp.NumeroPanneau6 = row1.NumeroPanneau6;
								copyOfout1_tmp.Sexe6 = row1.Sexe6;
								copyOfout1_tmp.Nom6 = row1.Nom6;
								copyOfout1_tmp.Prenom6 = row1.Prenom6;
								copyOfout1_tmp.Voix6 = row1.Voix6;
								copyOfout1_tmp.PourcentageVoix_Inscrit6 = row1.PourcentageVoix_Inscrit6;
								copyOfout1_tmp.PourcentageVoix_Exprime6 = row1.PourcentageVoix_Exprime6;
								copyOfout1_tmp.NumeroPanneau7 = row1.NumeroPanneau7;
								copyOfout1_tmp.Sexe7 = row1.Sexe7;
								copyOfout1_tmp.Nom7 = row1.Nom7;
								copyOfout1_tmp.Prenom7 = row1.Prenom7;
								copyOfout1_tmp.Voix7 = row1.Voix7;
								copyOfout1_tmp.PourcentageVoix_Inscrit7 = row1.PourcentageVoix_Inscrit7;
								copyOfout1_tmp.PourcentageVoix_Exprime7 = row1.PourcentageVoix_Exprime7;
								copyOfout1_tmp.NumeroPanneau8 = row1.NumeroPanneau8;
								copyOfout1_tmp.Sexe8 = row1.Sexe8;
								copyOfout1_tmp.Nom8 = row1.Nom8;
								copyOfout1_tmp.Prenom8 = row1.Prenom8;
								copyOfout1_tmp.Voix8 = row1.Voix8;
								copyOfout1_tmp.PourcentageVoix_Inscrit8 = row1.PourcentageVoix_Inscrit8;
								copyOfout1_tmp.PourcentageVoix_Exprime8 = row1.PourcentageVoix_Exprime8;
								copyOfout1_tmp.NumeroPanneau9 = row1.NumeroPanneau9;
								copyOfout1_tmp.Sexe9 = row1.Sexe9;
								copyOfout1_tmp.Nom9 = row1.Nom9;
								copyOfout1_tmp.Prenom9 = row1.Prenom9;
								copyOfout1_tmp.Voix9 = row1.Voix9;
								copyOfout1_tmp.PourcentageVoix_Inscrit9 = row1.PourcentageVoix_Inscrit9;
								copyOfout1_tmp.PourcentageVoix_Exprime9 = row1.PourcentageVoix_Exprime9;
								copyOfout1_tmp.NumeroPanneau10 = row1.NumeroPanneau10;
								copyOfout1_tmp.Sexe10 = row1.Sexe10;
								copyOfout1_tmp.Nom10 = row1.Nom10;
								copyOfout1_tmp.Prenom10 = row1.Prenom10;
								copyOfout1_tmp.Voix10 = row1.Voix10;
								copyOfout1_tmp.PourcentageVoix_Inscrit10 = row1.PourcentageVoix_Inscrit10;
								copyOfout1_tmp.PourcentageVoix_Exprime10 = row1.PourcentageVoix_Exprime10;
								copyOfout1_tmp.NumeroPanneau11 = row1.NumeroPanneau11;
								copyOfout1_tmp.Sexe11 = row1.Sexe11;
								copyOfout1_tmp.Nom11 = row1.Nom11;
								copyOfout1_tmp.Prenom11 = row1.Prenom11;
								copyOfout1_tmp.Voix11 = row1.Voix11;
								copyOfout1_tmp.PourcentageVoix_Inscrit11 = row1.PourcentageVoix_Inscrit11;
								copyOfout1_tmp.PourcentageVoix_Exprime11 = row1.PourcentageVoix_Exprime11;
...
///////////////////////		
								...
								String[] row_tLogRow_1 = new String[103];

								logRowUtil_tLogRow_1.putTableVerticalValue_0(copyOfout1, row_tLogRow_1);
								logRowUtil_tLogRow_1.putTableVerticalValue_1(copyOfout1, row_tLogRow_1);
...
///////////////////////    			
								...
								row4.NumeroPanneau11 = row2.NumeroPanneau11;
								row4.Sexe11 = row2.Sexe11;
								row4.Nom11 = row2.Nom11;
								row4.Prenom11 = row2.Prenom11;
								row4.Voix11 = row2.Voix11;
								row4.PourcentageVoix_Inscrit11 = row2.PourcentageVoix_Inscrit11;
								row4.PourcentageVoix_Exprime11 = row2.PourcentageVoix_Exprime11;
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final VoteElection VoteElectionClass = new VoteElection();

		int exitCode = VoteElectionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = VoteElection.class.getClassLoader()
					.getResourceAsStream("datamspr/voteelection_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = VoteElection.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : VoteElection");
		}
...
/************************************************************************************************
 * 477146 characters generated by Talend Open Studio for Data Integration on the
 * 15 avril 2024, 21:35:03 CEST
 ************************************************************************************************/